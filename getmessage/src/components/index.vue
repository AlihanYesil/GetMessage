        ...
        <div class="card chat-app">
          ...
          <div class="chat">
            ...
            <div class="chat-history">
              <ul class="m-b-0">
                  <li class="clearfix" v-bind:key="message" v-for="message in messages" v-html="message">
            ...
            <div class="chat-message clearfix">
              <div class="input-group mb-0">
                ...
                <input type="text" class="form-control" v-model="message"  placeholder="Mesaj" />
                <div class="input-group-prepend">
  ...
  methods: {
    ...
    sendMessage() {
      this.$socket.emit("new_message", {
        name: this.gelenBilgi.data.name,
